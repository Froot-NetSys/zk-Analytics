...
KAFKA_BROKERS="10.10.1.1:9092"; FDB_CLUSTER_FILE="$HOME/zktel-dist/fdb.cluster"
...
for cfg in samples:samples:samples_sum:1024 histogram:histogram:histogram_p90:1024 cm:cm:cm_topk:8192; do
  ...
  FDB_CLUSTER_FILE="$FDB_CLUSTER_FILE" bash scripts/reset_fdb.sh "$SUB" >/dev/null 2>&1 || true
