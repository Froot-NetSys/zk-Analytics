...
| `setup/setup_artifact_cluster.sh` | Shared SSH validation and deployment of all four pipeline binaries to every worker for distributed Figure 4, Table 2, Figure 5, and Table 3 runs. |
