...
export QUERY_TYPES="samples_sum,samples_sum_topk, samples_sum_key"
...
# - Used by: samples_sum_key_pattern
# - Format: hex pattern with wildcards, e.g., "0x12??34" or binary "b1010****"
