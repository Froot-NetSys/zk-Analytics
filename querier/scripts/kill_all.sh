...
patterns=(
  ...
  "querier"
  "zktelemetry-risc0-querier-host"
  "aggregator"
  "data_source"
  "/target/release/querier"
  "/target/debug/querier"
  "/target/release/zktelemetry-risc0-querier-host"
  "/target/debug/zktelemetry-risc0-querier-host"
  "/target/release/aggregator"
  "/target/debug/aggregator"
  "/target/release/data_source"
  "/target/debug/data_source"
  "cargo run -p querier"
  "cargo run -p zktelemetry-risc0-querier-host"
