-- Trillian MySQL storage schema.
-- Vendored verbatim from github.com/google/trillian
--   storage/mysql/schema/storage.sql (Apache-2.0).
-- Loaded into the `test` database by the mysql init entrypoint.
